...
<div class="full-width has-global-padding basic">
    <div class="wrap">
        <div id="content">
            <?php 
            ...
            <?php else: ?>
                <div class="no-res">
                    ...
                    <p>Sorry, we couldn't find any results for "<strong><?= esc_html(get_search_query()); ?></strong>".</p>
                    <p>Please try using different keywords or check the spelling.</p>
                </div>
            <?php endif; ?>        
        </div>
    </div>
