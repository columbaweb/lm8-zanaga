                    ...
                    <?php if (
                        ...
                        <div class="event__actions">
                            ...
                            <ul class="calendar-links">
                                ...
                                <li>
                                    <a class="cal-link" target="_blank" href="https://www.google.com/calendar/event?action=TEMPLATE&text=<?= urlencode(get_bloginfo('name') . ' - ' . ($title ?? 'Event')); ?>&dates=<?= $googleCalStartDate; ?>/<?= $googleCalEndDate; ?>&details=<?= urlencode($title ?? 'Event Details'); ?>&location=<?= urlencode($event_location ?? 'Location'); ?>">Google</a>
                                </li>
                            </ul>
                        </div>
                    <?php endif; ?>
